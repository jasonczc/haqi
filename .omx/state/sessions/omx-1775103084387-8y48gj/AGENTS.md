...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775103084387-8y48gj | 2026-04-02T04:11:24.654Z

**Codebase Map:**
  scripts/: apply-haqi-brand, check-haqi-brand, common
  cli/: build-executable, prepare-npm-packages, release-all, unpack-tools, update-homebrew-formula, write-embedded-assets-stub, AgentRegistry, AcpMessageHandler.test, AcpMessageHandler, AcpSdkBackend.test
  daemon/: build, browser, computerUse.test, computerUse, recording.test, recording, vnc.test, vnc, detector.test
  docs/: config
  hub/: cleanup-sessions, download-tunwg, generate-embedded-web-assets, checkpointRegistry.test, checkpointRegistry, environmentRegistry.test, environmentRegistry, previewRegistry.test, previewRegistry, provider.test
  shared/: messages, modes, schemas, sessionSummary, socket, types, utils, version, voice
  web/: App, client, voice, modelConfig, normalize, normalizeAgent.test, normalizeAgent, normalizeUser, presentation, reconcile
  website/: App, AppShowcase, ErrorBoundary, LanguageToggle, Layout, ManusDialog, Map, ModeToggle, SEO, accordion
