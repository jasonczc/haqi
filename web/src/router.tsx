                    ...
                    <div className="sidebar-tabbar">
                        <div className="tab-items">
                            <button className="icon-button" style={{ width: '26px' }} aria-label="Chat">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9a2 2 0 0 1-2 2H6l-4 4V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2z"/><path d="M18 8h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1"/></svg>
                            </button>
                            <button className="icon-button" style={{ width: '26px' }} aria-label="Routines">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 7 5 9 8 5"/><line x1="12" y1="7" x2="21" y2="7"/><polyline points="3 17 5 19 8 15"/><line x1="12" y1="17" x2="21" y2="17"/></svg>
                            </button>
