            ...
            <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-xs text-[var(--cursor-text-tertiary)]">
                            [{clampedStep + 1}/{total}]
                        </span>
                    </div>
                </div>
                ...
                <div className="mt-3">
                    ...
                    {isPureTextQuestion ? (
                        ...
                        <>
                            ...
                            <div className="mt-3">
                                <div className="text-xs text-[var(--cursor-text-tertiary)] mb-1">
                                ...
                                <textarea
                                    ...
                                    className="w-full min-h-[60px] resize-y rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-card)] px-3 py-2 text-sm text-[var(--cursor-text-primary)] placeholder:text-[var(--cursor-text-tertiary)] focus:outline-none focus:ring-2 focus:ring-[var(--cursor-button)] focus:border-transparent disabled:opacity-50"
                                />
                            </div>
                        </>
                    )}
