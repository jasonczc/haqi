                ...
                if (block.kind === 'agent-event') {
                    ...
                    return (
                        <div key={`event:${block.id}`} className="chat-agent-event-row py-1">
                            <div className="chat-agent-event mx-auto w-fit max-w-[88%] px-2 text-center text-xs text-[var(--app-hint)] opacity-80 sm:max-w-[84%] lg:max-w-[76%]">
                                    ...
                                    <>
                                        ...
                                        {taskChildren && taskChildren.rest.length > 0 ? (
                                            <details className={`chat-task-details ${isCompact ? 'mt-1.5' : 'mt-2'}`}>
                                                <summary className="chat-task-details-summary cursor-pointer text-xs text-[var(--app-hint)]">
