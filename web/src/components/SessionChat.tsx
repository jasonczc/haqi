...
type ExtendedSessionMetadata = NonNullable<Session['metadata']> & {
    archiveDetail?: SessionArchiveDetail
...
function SessionInactiveBanner(props: {
    ...
    const detail = (props.session.metadata as ExtendedSessionMetadata | undefined)?.archiveDetail
    ...
    if (detail) {
        ...
        return (
            <div className="px-3 pt-3">
                <div className="w-full rounded-lg border border-[var(--danger)]/40 bg-[var(--danger)]/10 px-4 py-3 text-[var(--cursor-text-primary)]">
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <button
                            ...
                            className="shrink-0 rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-card)] px-3 py-1.5 text-[12px] font-medium text-[var(--cursor-text-primary)] transition-colors hover:bg-[var(--cursor-bg-hover)] disabled:opacity-60"
                        >
                            {props.resumePending ? 'Retrying...' : 'Retry'}
                        </button>
                    </div>
                    {stderrTrimmed ? (
                        <div className="mt-2">
                            <button
                                type="button"
                                onClick={() => setStderrExpanded((value) => !value)}
                    ...
                    {stdoutTrimmed && stdoutTrimmed !== stderrTrimmed ? (
                        <div className="mt-2">
                            <button
                                type="button"
                                onClick={() => setStdoutExpanded((value) => !value)}
                                className="flex items-center gap-1 text-[11px] font-semibold text-[var(--cursor-text-secondary)] hover:text-[var(--cursor-text-primary)]"
                            >
                                <span>stdout</span>
                                <span>{stdoutExpanded ? 'v' : '>'}</span>
                            </button>
                            {stdoutExpanded ? (
                                <pre className="mt-1 max-h-64 overflow-auto rounded bg-[var(--cursor-bg-app)] p-2 font-mono text-[11px] leading-relaxed text-[var(--cursor-text-secondary)] whitespace-pre-wrap break-all">
                                    {stdoutTrimmed}
...
export function SessionChat(props: {
    ...
    const sessionContainerId = (props.session.metadata as ExtendedSessionMetadata | undefined)?.containerId

    return (
        <div className="chat-main flex min-h-0 flex-1 flex-col">
            <SessionHeader
                session={props.session}
                onBack={props.onBack}
                ...
                onViewDesktop={sessionContainerId ? handleViewDesktop : undefined}
            ...
            <AssistantRuntimeProvider runtime={runtime}>
                <div className={`chat-center relative flex min-h-0 flex-1 flex-col${props.viewMode === 'cli' ? ' cli-session' : ''}`}>
                    ...
                    <HappyComposer
                        ...
                        rateLimitSnapshot={props.session.metadata?.rateLimitSnapshot}
            ...
            <Dialog open={isMcpDialogOpen} onOpenChange={setIsMcpDialogOpen}>
                <DialogContent className="max-h-[85vh] max-w-2xl overflow-hidden">
                    ...
                    <div className="mt-3 max-h-[calc(85vh-7rem)] space-y-3 overflow-y-auto pr-1">
                        <div
                            className={`rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-quiet)] p-3 ${!isMcpGuideExpanded ? 'cursor-pointer' : ''}`}
                            onClick={() => {
                            ...
                            {isMcpGuideExpanded ? (
                                <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                    {MCP_GUIDES.map((guide) => (
                                        <div
                                            key={guide.id}
                                            className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-hover)] p-2.5"
                                        >
                                            <div className="text-sm font-semibold text-[var(--cursor-text-primary)]">
                                                {guide.label}
                                            </div>
                                            <div className="mt-1 text-xs text-[var(--cursor-text-tertiary)]">
                                            ...
                                            <div className="mt-2 flex items-center gap-2">
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="rounded-md border border-[var(--cursor-stroke-primary)] px-2 py-1 text-xs text-[var(--cursor-text-primary)] transition-colors hover:bg-[var(--cursor-bg-hover)]"
                                                >
                                                    {t('mcp.guide.open')}
                                                </a>
                                                <button
                                    ...
                                    <div className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-hover)] p-2.5">
                                        <div className="text-sm font-semibold text-[var(--cursor-text-primary)]">
                                        ...
                                        <div className="mt-2 space-y-2">
                                            <input
                                                ...
                                                className="w-full rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-card)] px-2 py-1.5 text-xs text-[var(--cursor-text-primary)] outline-none transition-colors focus:border-[var(--cursor-link)]"
                                            ...
                                            <button
                                                ...
                                                className="w-full rounded-md border border-[var(--cursor-stroke-primary)] px-2 py-1 text-xs text-[var(--cursor-text-primary)] transition-colors hover:bg-[var(--cursor-bg-hover)] disabled:cursor-not-allowed disabled:opacity-50"
                                            >
                                                {t('mcp.guide.insertPrompt')}
                                            </button>
                                        </div>
                        ...
                        {mcpWarning ? (
                            <div className="rounded-md border border-[var(--warn)]/30 bg-[var(--warn)]/10 p-3 text-sm text-[var(--warn)]">
                                {mcpWarning}
                            </div>
                        ) : null}
                                        ...
                                        {codexQueueStatus ? (
                                            <div className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-quiet)] p-3 sm:col-span-2">
                                                ...
                                                <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-3">
                                                    <div className="rounded-md bg-[var(--cursor-bg-hover)] p-2">
                                                            ...
                                                            <span
                                                                className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
                                                                    codexQueueStatus.inQueue
                                                                        ? 'bg-[var(--success)]/10 text-[var(--success)]'
                                                                        : 'bg-[var(--cursor-bg-hover)] text-[var(--cursor-text-tertiary)]'
                                                                }`}
                                                            >
                                                ...
                                                {codexQueueStatus.nextPreview ? (
                                                    <div className="mt-2 rounded-md bg-[var(--cursor-bg-hover)] p-2">
                                                        <div className="text-[10px] uppercase tracking-wide text-[var(--cursor-text-tertiary)]">
                                                            Next queued message
                                                        </div>
                                                    ...
                                                    {isRateLimit && rateLimit ? (
                                                        <div className="mt-2 space-y-2">
                                                            <div className="flex items-center justify-between gap-3">
                                                                ...
                                                                <span className="text-xs text-[var(--cursor-text-tertiary)] break-all">
                                                                    {rateLimit.resetAt}
                                                                </span>
                                                            </div>
                                                            {usedPercent !== null ? (
                                                                <div className="h-1.5 w-full overflow-hidden rounded-full bg-[var(--cursor-bg-hover)]">
                                                                    <div
                                                        ...
                                                        <div className="mt-2 break-all text-sm font-mono text-[var(--cursor-text-primary)]">
                                    ...
                                    <div className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-quiet)] p-3">
                                        ...
                                        <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                            ...
                                            {sessionUsage.allTime.reasoningOutputTokens > 0 ? (
                                                <div className="rounded-md bg-[var(--cursor-bg-hover)] p-2 sm:col-span-2">
                                                    <div className="text-[10px] uppercase tracking-wide text-[var(--cursor-text-tertiary)]">
                                        ...
                                        <div className="mt-2 text-[10px] text-[var(--cursor-text-tertiary)]">
