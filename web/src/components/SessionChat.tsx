                            ...
                            {isMcpGuideExpanded ? (
                                <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                    {MCP_GUIDES.map((guide) => (
                                        <div
                                            key={guide.id}
                                            className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-quiet)] p-2.5"
                                        >
                                    ...
                                    <div className="rounded-md border border-[var(--cursor-stroke-primary)] bg-[var(--cursor-bg-quiet)] p-2.5">
                                        <div className="text-sm font-semibold text-[var(--cursor-text-primary)]">
                                                            ...
                                                            <span
                                                                className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
                                                                    codexQueueStatus.inQueue
                                                                        ? 'bg-[var(--success)]/10 text-[var(--success)]'
                                                                        : 'bg-[var(--cursor-bg-quiet)] text-[var(--cursor-text-tertiary)]'
                                                                }`}
                                                            >
                                                ...
                                                >
                                                    ...
                                                    {isRateLimit && rateLimit ? (
                                                        <div className="mt-2 space-y-2">
                                                            ...
                                                            {usedPercent !== null ? (
                                                                <div className="h-1.5 w-full overflow-hidden rounded-full bg-[var(--cursor-bg-quiet)]">
                                                                    <div
