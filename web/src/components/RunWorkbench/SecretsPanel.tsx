...
function SecretRow(props: {
    ...
    const { secret } = props
    return (
        <div className="flex items-center justify-between gap-2 border-b border-[var(--border-tertiary)] px-4 py-2.5 last:border-b-0">
            ...
            <button
                ...
                className="rounded p-1 text-[var(--text-tertiary)] hover:text-[var(--danger)] hover:bg-[var(--bg-danger-secondary)] transition-colors disabled:opacity-50"
                title="Delete secret"
            >
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between border-b border-[var(--border-tertiary)] px-4 py-2.5">
                ...
                <button
                    ...
                    className="flex items-center gap-1 rounded px-2 py-1 text-[11px] font-medium text-[var(--accent)] hover:bg-[var(--bg-accent-secondary)] transition-colors"
                >
            ...
            {/* Add form */}
            {showAdd && (
                <div className="border-b border-[var(--border-tertiary)] bg-[var(--bg-quaternary)] px-4 py-3 space-y-2">
                    <input
                        type="text"
                        value={newName}
                        onChange={(e) => setNewName(e.target.value)}
                        placeholder="SECRET_NAME"
                        className="w-full rounded border border-[var(--border-secondary)] bg-[var(--bg-editor)] px-2.5 py-1.5 text-[12px] font-mono focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
                    />
                    <input
                        type="password"
                        value={newValue}
                        ...
                        placeholder="Value"
                        className="w-full rounded border border-[var(--border-secondary)] bg-[var(--bg-editor)] px-2.5 py-1.5 text-[12px] focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
                    />
                    <input
                        type="text"
                    ...
                    <div className="flex justify-end gap-2">
                        <button
                            ...
                            className="rounded px-3 py-1 text-[11px] text-[var(--text-tertiary)] hover:bg-[var(--bg-tertiary)] transition-colors"
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            className="rounded bg-[var(--bg-neutral)] px-3 py-1 text-[11px] font-medium text-[var(--bg-editor)] disabled:opacity-50 transition-colors"
                        >
            ...
            <div className="flex-1 overflow-y-auto">
                {secretsQuery.isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-sm text-[var(--text-tertiary)]">
