export default {
  ...
  // Codex queue dialog
  'codexQueue.mode.direct': 'Direct',
  'codexQueue.mode.queue': 'Queue',
  'codexQueue.mode.directHint': 'Send immediately (classic behavior)',
  'codexQueue.mode.queueHint': 'Allow sending while running (queued)',
  'codexQueue.dialog.title': 'Codex queue',
  'codexQueue.dialog.description': 'Inspect and manage pending queued messages',
  'codexQueue.dialog.modeLabel': 'Send mode',
  'codexQueue.dialog.refresh': 'Refresh',
  'codexQueue.dialog.clear': 'Clear all',
  'codexQueue.dialog.loading': 'Loading queue…',
  'codexQueue.dialog.fetchError': 'Failed to load queue',
  'codexQueue.dialog.actionError': 'Queue operation failed',
  'codexQueue.dialog.empty': 'No queued messages',
  'codexQueue.dialog.emptyMessage': '(empty message)',
  'codexQueue.summary.pending': 'Pending',
  'codexQueue.summary.inQueue': 'In queue',
  'codexQueue.summary.taskRunning': 'Task running',
  'codexQueue.entry.isolate': 'isolated',
