 ...
 *
 * Environment:
 *   HOMEBREW_TAP_REPO - Git URL of the tap repository (default: https://github.com/jasonczc/homebrew-tap.git)
 */
...
class Hapi < Formula
  ...
  homepage "https://github.com/jasonczc/haqi"
  version "${version}"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jasonczc/haqi/releases/download/v#{version}/hapi-darwin-arm64.tar.gz"
      sha256 "${shas.darwinArm64}"
    else
      url "https://github.com/jasonczc/haqi/releases/download/v#{version}/hapi-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/jasonczc/haqi/releases/download/v#{version}/hapi-linux-arm64.tar.gz"
      sha256 "${shas.linuxArm64}"
    else
      url "https://github.com/jasonczc/haqi/releases/download/v#{version}/hapi-linux-x64.tar.gz"
...
async function main(): Promise<void> {
    ...
    const tapRepo = process.env.HOMEBREW_TAP_REPO || 'https://github.com/jasonczc/homebrew-tap.git';
